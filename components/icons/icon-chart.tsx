const IconChart = ({ className }: any) => {
    return (
        ...
        >
            <path
                opacity="0.5"
                d="M21.2099 15.89C20.5737 17.3945 19.5787 18.7202 18.3118 19.7513C17.0449 20.7824 15.5447 21.4874 13.9424 21.8048C12.34 22.1222 10.6843 22.0422 9.12006 21.5718C7.55578 21.1015 6.13054 20.2551 4.96893 19.1067C3.80733 17.9583 2.94473 16.5428 2.45655 14.984C1.96837 13.4252 1.86948 11.7705 2.16851 10.1647C2.46755 8.5588 3.15541 7.05064 4.17196 5.77205C5.18851 4.49345 6.5028 3.48333 7.99992 2.83002"
                stroke="#22C55E"
                strokeWidth="2"
                strokeLinecap="round"
